...
inquirer
  .prompt([
    // ask user what function they want to perform
    {
      type: "input",
      message: "Hello and Welcome! I'm Liri. What is your name?",
      name: "username"
    },
    {
      type: "list",
      message: "Nice to meet you! How can I help you today?",
      choices: ["Search for concerts", "Search a song", "Search a movie", "Mysterious Random Choice: who knows what you'll get!"],
      name: "choice"
    }
